...
import {diferenciaAnio, calcularMarca, obtenerPlan} from '../helper';
...
const Formulario = ({guardarResumen, guardarCargando}) => {
    ...
    // validamos cuando se ejecuta el submit
    const cotizarSeguro = ev => {
        ...
        const diferencia = diferenciaAnio(anio);
        // restar 3% por cada año
        resultado -= ((diferencia * 3) * resultado) /100;
        // % de incremento para americano 15%, europeo 30%, asiatico 5%
